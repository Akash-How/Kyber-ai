...
>(({ className, variant, ...props }, ref) => {
  ...
  const defaultSuggestions: Suggestion[] = [
    ...
    {
      id: "demo-resume-suggestion",
      title: "Demo Resume",
      detailedSuggestion: "Load a demo resume and generate ATS insights.",
      messageId: "demo-resume-query",
    },
  ];
  ...
  return (
    <div className="flex h-full w-full">
      ...
      >
        ...
        {/* Message suggestions */}
        <MessageSuggestions maxSuggestions={4} initialSuggestions={defaultSuggestions}>
          <MessageSuggestionsList />
        </MessageSuggestions>
      </ThreadContainer>
