      ...
      {suggestions.length > 0
        ? suggestions.map((suggestion, index) => (
            ...
            >
              <button
                className={cn(
                  "inline-flex items-center gap-1.5 py-2 px-2.5 rounded-2xl text-xs transition-colors",
                  "border border-flat",
                  suggestion.id === "demo-resume-suggestion"
                    ? "transition-[transform,color,border-color] duration-180 ease-out hover:-translate-y-px border-white/12 text-white/78 hover:border-white/20 hover:text-white/95"
                    : "",
                ...
                onClick={async () => {
                  ...
                  if (suggestion.id === "demo-resume-suggestion") {
